...
<p align="center">
  <strong>Universal State Runtime para inferencia local de LLM en Apple Silicon: MLX, Metal, NEON, ruta ANE y CLI práctico.</strong><br />
...
Universal State Runtime para inferencia local de LLM en Apple Silicon: MLX, Metal, NEON, ruta ANE y CLI práctico.
