...
<p align="center">
  <strong>Universal State Runtime для локального LLM inference на Apple Silicon: MLX, Metal, NEON, ANE pathing и практичный CLI.</strong><br />
...
Universal State Runtime для локального LLM inference на Apple Silicon: MLX, Metal, NEON, ANE pathing и практичный CLI.
